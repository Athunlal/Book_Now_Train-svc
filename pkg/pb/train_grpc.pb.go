...
type TrainManagementClient interface {
	...
	UpdateTrainRoute(ctx context.Context, in *UpdateTrainRouteRequest, opts ...grpc.CallOption) (*UpdateTrainRouteResponse, error)
}
...
func (c *trainManagementClient) UpdateTrainRoute(ctx context.Context, in *UpdateTrainRouteRequest, opts ...grpc.CallOption) (*UpdateTrainRouteResponse, error) {
	out := new(UpdateTrainRouteResponse)
...
type TrainManagementServer interface {
	...
	UpdateTrainRoute(context.Context, *UpdateTrainRouteRequest) (*UpdateTrainRouteResponse, error)
...
func (UnimplementedTrainManagementServer) UpdateTrainRoute(context.Context, *UpdateTrainRouteRequest) (*UpdateTrainRouteResponse, error) {
...
func _TrainManagement_UpdateTrainRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateTrainRouteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrainManagementServer).UpdateTrainRoute(ctx, req.(*UpdateTrainRouteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
